...
value class JniScope(val env: JNIEnvVar) {
    ...
    fun JvmField.setDouble(value: Double, instance: JvmObject = JvmObject.NULL) =
        setDouble(env, value, instance)

    fun JvmField.setBoolean(value: Boolean, instance: JvmObject = JvmObject.NULL) =
        setBoolean(env, value, instance)

    fun JvmField.setObject(value: JvmObject, instance: JvmObject = JvmObject.NULL) =
